...
const Beneficiary = () => {
    ...
    const [postcode, setposcode] = React.useState('')
    ...
    return (
        ...
        <form name='beneficiary-personal' onSubmit={handlesubmit} >
            ...
            <input type="radio" value="swift" checked={bankdetails === 'swift'} id='swift' onChange={(e) => setbankdetails(e.target.value)} /><label htmlFor='swift' >SWIFT Details</label>
            <br /><br /><br />
